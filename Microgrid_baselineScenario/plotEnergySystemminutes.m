function plotEnergySystemminutes(t, Pli, Pld, Pls, Ppl, Ppg, Pgl, X, C_in, C_ex, Pp)
...
xticks(1:12:96);              % every 3 hours
xticklabels(0:3:24);          % relabel as hours
xlabel('Time [hours]');
...
subplot(2,1,2); 
stairs(t, Ptotal,'-r','LineWidth',1,'Color','k','DisplayName','Total Load'); 
hold on;
